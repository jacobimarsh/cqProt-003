...
python fastStructure/structure.py -K 4 --input=fin_b51_protein_Gm20.SNPs.id.biallic_maf_0.01_geno_0.1.vcf --output=fin_b51_protein_Gm20.SNPs.id.biallic_maf_0.01_geno_0.1.vcf_simple --prior=simple
grep '#CHROM' fin_b51_protein_Gm20.SNPs.id.biallic_maf_0.01_geno_0.1.vcf >> temppopfile.txt
