module load java
tassel-5-standalone/run_pipeline.pl -Xmx100g -h fin_b51_protein_Gm20.SNPs.id.biallic_maf_0.01_geno_0.1.hmp.txt -KinshipPlugin -method Centered_IBS -endPlugin -export fin_b51_protein_Gm20.SNPs.id.biallic_maf_0.01_geno_0.1_kinship.txt -exportType SqrMatrix
